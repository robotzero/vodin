...
foreign xcb {
	...
	connect_to_fd :: proc(fd: _c.int, authInfo: ^AuthInfo) -> ^Connection ---
	...
	create_window_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u32, Aux: ^CreateWindowValueList) -> _c.int ---

	@(link_name = "xcb_create_window_value_list_unpack")
	create_window_value_list_unpack :: proc(Buffer: rawptr, valueMask: u32, Aux: ^CreateWindowValueList) -> _c.int ---

	@(link_name = "xcb_create_window_value_list_sizeof")
	create_window_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u32) -> _c.int ---

	@(link_name = "xcb_create_window_sizeof")
	create_window_sizeof :: proc(Buffer: rawptr) -> _c.int ---

	@(link_name = "xcb_create_window_checked")
	create_window_checked :: proc(c: ^Connection, depth: u8, wid: u32, parent: u32, x: i16, y: i16, width: u16, height: u16, borderWidth: u16, Class: u16, visual: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_create_window")
	create_window :: proc(c: ^Connection, depth: u8, wid: u32, parent: u32, x: i16, y: i16, width: u16, height: u16, borderWidth: u16, Class: u16, visual: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_create_window_aux_checked")
	create_window_aux_checked :: proc(c: ^Connection, depth: u8, wid: u32, parent: u32, x: i16, y: i16, width: u16, height: u16, borderWidth: u16, Class: u16, visual: u32, valueMask: u32, valueList: ^CreateWindowValueList) -> VoidCookie ---

	@(link_name = "xcb_create_window_aux")
	create_window_aux :: proc(c: ^Connection, depth: u8, wid: u32, parent: u32, x: i16, y: i16, width: u16, height: u16, borderWidth: u16, Class: u16, visual: u32, valueMask: u32, valueList: ^CreateWindowValueList) -> VoidCookie ---
	...
	change_window_attributes_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u32, Aux: ^ChangeWindowAttributesValueList) -> _c.int ---

	@(link_name = "xcb_change_window_attributes_value_list_unpack")
	change_window_attributes_value_list_unpack :: proc(Buffer: rawptr, valueMask: u32, Aux: ^ChangeWindowAttributesValueList) -> _c.int ---

	@(link_name = "xcb_change_window_attributes_value_list_sizeof")
	change_window_attributes_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u32) -> _c.int ---
	...
	change_window_attributes_checked :: proc(c: ^Connection, window: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_window_attributes")
	change_window_attributes :: proc(c: ^Connection, window: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_window_attributes_aux_checked")
	change_window_attributes_aux_checked :: proc(c: ^Connection, window: u32, valueMask: u32, valueList: ^ChangeWindowAttributesValueList) -> VoidCookie ---

	@(link_name = "xcb_change_window_attributes_aux")
	change_window_attributes_aux :: proc(c: ^Connection, window: u32, valueMask: u32, valueList: ^ChangeWindowAttributesValueList) -> VoidCookie ---
	...
	configure_window_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u16, Aux: ^ConfigureWindowValueList) -> _c.int ---

	@(link_name = "xcb_configure_window_value_list_unpack")
	configure_window_value_list_unpack :: proc(Buffer: rawptr, valueMask: u16, Aux: ^ConfigureWindowValueList) -> _c.int ---

	@(link_name = "xcb_configure_window_value_list_sizeof")
	configure_window_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u16) -> _c.int ---
	...
	configure_window_checked :: proc(c: ^Connection, window: u32, valueMask: u16, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_configure_window")
	configure_window :: proc(c: ^Connection, window: u32, valueMask: u16, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_configure_window_aux_checked")
	configure_window_aux_checked :: proc(c: ^Connection, window: u32, valueMask: u16, valueList: ^ConfigureWindowValueList) -> VoidCookie ---

	@(link_name = "xcb_configure_window_aux")
	configure_window_aux :: proc(c: ^Connection, window: u32, valueMask: u16, valueList: ^ConfigureWindowValueList) -> VoidCookie ---
	...
	intern_atom :: proc(c: ^Connection, onlyIfExists: u8, nameLen: u16, name: cstring) -> InternAtomCookie ---

	@(link_name = "xcb_intern_atom_unchecked")
	intern_atom_unchecked :: proc(c: ^Connection, onlyIfExists: u8, nameLen: u16, name: cstring) -> InternAtomCookie ---
	...
	change_property_checked :: proc(c: ^Connection, mode: u8, window: u32, property: u32, type: u32, format: u8, dataLen: u32, data: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_property")
	change_property :: proc(c: ^Connection, mode: u8, window: u32, property: u32, type: u32, format: u8, dataLen: u32, data: rawptr) -> VoidCookie ---
	...
	get_property :: proc(c: ^Connection, Delete: u8, window: u32, property: u32, type: u32, longOffset: u32, longLength: u32) -> GetPropertyCookie ---

	@(link_name = "xcb_get_property_unchecked")
	get_property_unchecked :: proc(c: ^Connection, Delete: u8, window: u32, property: u32, type: u32, longOffset: u32, longLength: u32) -> GetPropertyCookie ---
	...
	send_event_checked :: proc(c: ^Connection, propagate: u8, destination: u32, eventMask: u32, event: cstring) -> VoidCookie ---

	@(link_name = "xcb_send_event")
	send_event :: proc(c: ^Connection, propagate: u8, destination: u32, eventMask: u32, event: cstring) -> VoidCookie ---

	@(link_name = "xcb_grab_pointer")
	grab_pointer :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, eventMask: u16, pointerMode: u8, keyboardMode: u8, confineTo: u32, cursor: u32, time: u32) -> GrabPointerCookie ---

	@(link_name = "xcb_grab_pointer_unchecked")
	grab_pointer_unchecked :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, eventMask: u16, pointerMode: u8, keyboardMode: u8, confineTo: u32, cursor: u32, time: u32) -> GrabPointerCookie ---
	...
	grab_button_checked :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, eventMask: u16, pointerMode: u8, keyboardMode: u8, confineTo: u32, cursor: u32, button: u8, modifiers: u16) -> VoidCookie ---

	@(link_name = "xcb_grab_button")
	grab_button :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, eventMask: u16, pointerMode: u8, keyboardMode: u8, confineTo: u32, cursor: u32, button: u8, modifiers: u16) -> VoidCookie ---

	@(link_name = "xcb_ungrab_button_checked")
	ungrab_button_checked :: proc(c: ^Connection, button: u8, grabWindow: u32, modifiers: u16) -> VoidCookie ---

	@(link_name = "xcb_ungrab_button")
	ungrab_button :: proc(c: ^Connection, button: u8, grabWindow: u32, modifiers: u16) -> VoidCookie ---

	@(link_name = "xcb_change_active_pointer_grab_checked")
	change_active_pointer_grab_checked :: proc(c: ^Connection, cursor: u32, time: u32, eventMask: u16) -> VoidCookie ---

	@(link_name = "xcb_change_active_pointer_grab")
	change_active_pointer_grab :: proc(c: ^Connection, cursor: u32, time: u32, eventMask: u16) -> VoidCookie ---

	@(link_name = "xcb_grab_keyboard")
	grab_keyboard :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, time: u32, pointerMode: u8, keyboardMode: u8) -> GrabKeyboardCookie ---

	@(link_name = "xcb_grab_keyboard_unchecked")
	grab_keyboard_unchecked :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, time: u32, pointerMode: u8, keyboardMode: u8) -> GrabKeyboardCookie ---
	...
	grab_key_checked :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, modifiers: u16, key: u8, pointerMode: u8, keyboardMode: u8) -> VoidCookie ---

	@(link_name = "xcb_grab_key")
	grab_key :: proc(c: ^Connection, ownerEvents: u8, grabWindow: u32, modifiers: u16, key: u8, pointerMode: u8, keyboardMode: u8) -> VoidCookie ---

	@(link_name = "xcb_ungrab_key_checked")
	ungrab_key_checked :: proc(c: ^Connection, key: u8, grabWindow: u32, modifiers: u16) -> VoidCookie ---

	@(link_name = "xcb_ungrab_key")
	ungrab_key :: proc(c: ^Connection, key: u8, grabWindow: u32, modifiers: u16) -> VoidCookie ---
	...
	translate_coordinates :: proc(c: ^Connection, srcWindow: u32, dstWindow: u32, srcX: i16, srcY: i16) -> TranslateCoordinatesCookie ---

	@(link_name = "xcb_translate_coordinates_unchecked")
	translate_coordinates_unchecked :: proc(c: ^Connection, srcWindow: u32, dstWindow: u32, srcX: i16, srcY: i16) -> TranslateCoordinatesCookie ---
	...
	warp_pointer_checked :: proc(c: ^Connection, srcWindow: u32, dstWindow: u32, srcX: i16, srcY: i16, srcWidth: u16, srcHeight: u16, dstX: i16, dstY: i16) -> VoidCookie ---

	@(link_name = "xcb_warp_pointer")
	warp_pointer :: proc(c: ^Connection, srcWindow: u32, dstWindow: u32, srcX: i16, srcY: i16, srcWidth: u16, srcHeight: u16, dstX: i16, dstY: i16) -> VoidCookie ---

	@(link_name = "xcb_set_input_focus_checked")
	set_input_focus_checked :: proc(c: ^Connection, revertTo: u8, focus: u32, time: u32) -> VoidCookie ---

	@(link_name = "xcb_set_input_focus")
	set_input_focus :: proc(c: ^Connection, revertTo: u8, focus: u32, time: u32) -> VoidCookie ---
	...
	open_font_checked :: proc(c: ^Connection, fid: u32, nameLen: u16, name: cstring) -> VoidCookie ---

	@(link_name = "xcb_open_font")
	open_font :: proc(c: ^Connection, fid: u32, nameLen: u16, name: cstring) -> VoidCookie ---
	...
	query_text_extents_sizeof :: proc(Buffer: rawptr, stringLen: u32) -> _c.int ---

	@(link_name = "xcb_query_text_extents")
	query_text_extents :: proc(c: ^Connection, font: u32, stringLen: u32, string: ^Char2B) -> QueryTextExtentsCookie ---

	@(link_name = "xcb_query_text_extents_unchecked")
	query_text_extents_unchecked :: proc(c: ^Connection, font: u32, stringLen: u32, string: ^Char2B) -> QueryTextExtentsCookie ---
	...
	list_fonts :: proc(c: ^Connection, maxNames: u16, patternLen: u16, pattern: cstring) -> ListFontsCookie ---

	@(link_name = "xcb_list_fonts_unchecked")
	list_fonts_unchecked :: proc(c: ^Connection, maxNames: u16, patternLen: u16, pattern: cstring) -> ListFontsCookie ---
	...
	list_fonts_with_info :: proc(c: ^Connection, maxNames: u16, patternLen: u16, pattern: cstring) -> ListFontsWithInfoCookie ---

	@(link_name = "xcb_list_fonts_with_info_unchecked")
	list_fonts_with_info_unchecked :: proc(c: ^Connection, maxNames: u16, patternLen: u16, pattern: cstring) -> ListFontsWithInfoCookie ---
	...
	set_font_path_checked :: proc(c: ^Connection, fontQty: u16, font: ^Str) -> VoidCookie ---

	@(link_name = "xcb_set_font_path")
	set_font_path :: proc(c: ^Connection, fontQty: u16, font: ^Str) -> VoidCookie ---
	...
	create_gc_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u32, Aux: ^CreateGcValueList) -> _c.int ---

	@(link_name = "xcb_create_gc_value_list_unpack")
	create_gc_value_list_unpack :: proc(Buffer: rawptr, valueMask: u32, Aux: ^CreateGcValueList) -> _c.int ---

	@(link_name = "xcb_create_gc_value_list_sizeof")
	create_gc_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u32) -> _c.int ---

	@(link_name = "xcb_create_gc_sizeof")
	create_gc_sizeof :: proc(Buffer: rawptr) -> _c.int ---

	@(link_name = "xcb_create_gc_checked")
	create_gc_checked :: proc(c: ^Connection, cid: u32, drawable: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_create_gc")
	create_gc :: proc(c: ^Connection, cid: u32, drawable: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_create_gc_aux_checked")
	create_gc_aux_checked :: proc(c: ^Connection, cid: u32, drawable: u32, valueMask: u32, valueList: ^CreateGcValueList) -> VoidCookie ---

	@(link_name = "xcb_create_gc_aux")
	create_gc_aux :: proc(c: ^Connection, cid: u32, drawable: u32, valueMask: u32, valueList: ^CreateGcValueList) -> VoidCookie ---
	...
	change_gc_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u32, Aux: ^ChangeGcValueList) -> _c.int ---

	@(link_name = "xcb_change_gc_value_list_unpack")
	change_gc_value_list_unpack :: proc(Buffer: rawptr, valueMask: u32, Aux: ^ChangeGcValueList) -> _c.int ---

	@(link_name = "xcb_change_gc_value_list_sizeof")
	change_gc_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u32) -> _c.int ---

	@(link_name = "xcb_change_gc_sizeof")
	change_gc_sizeof :: proc(Buffer: rawptr) -> _c.int ---

	@(link_name = "xcb_change_gc_checked")
	change_gc_checked :: proc(c: ^Connection, gc: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_gc")
	change_gc :: proc(c: ^Connection, gc: u32, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_gc_aux_checked")
	change_gc_aux_checked :: proc(c: ^Connection, gc: u32, valueMask: u32, valueList: ^ChangeGcValueList) -> VoidCookie ---

	@(link_name = "xcb_change_gc_aux")
	change_gc_aux :: proc(c: ^Connection, gc: u32, valueMask: u32, valueList: ^ChangeGcValueList) -> VoidCookie ---

	@(link_name = "xcb_change_gc_value_list")
	change_gc_value_list :: proc(r: ^ChangeGcRequest) -> rawptr ---

	@(link_name = "xcb_copy_gc_checked")
	copy_gc_checked :: proc(c: ^Connection, srcGc: u32, dstGc: u32, valueMask: u32) -> VoidCookie ---

	@(link_name = "xcb_copy_gc")
	copy_gc :: proc(c: ^Connection, srcGc: u32, dstGc: u32, valueMask: u32) -> VoidCookie ---

	@(link_name = "xcb_set_dashes_sizeof")
	set_dashes_sizeof :: proc(Buffer: rawptr) -> _c.int ---

	@(link_name = "xcb_set_dashes_checked")
	set_dashes_checked :: proc(c: ^Connection, gc: u32, dashOffset: u16, dashesLen: u16, dashes: ^u8) -> VoidCookie ---

	@(link_name = "xcb_set_dashes")
	set_dashes :: proc(c: ^Connection, gc: u32, dashOffset: u16, dashesLen: u16, dashes: ^u8) -> VoidCookie ---
	...
	set_clip_rectangles_sizeof :: proc(Buffer: rawptr, rectanglesLen: u32) -> _c.int ---

	@(link_name = "xcb_set_clip_rectangles_checked")
	set_clip_rectangles_checked :: proc(c: ^Connection, ordering: u8, gc: u32, clipX_origin: i16, clipY_origin: i16, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---

	@(link_name = "xcb_set_clip_rectangles")
	set_clip_rectangles :: proc(c: ^Connection, ordering: u8, gc: u32, clipX_origin: i16, clipY_origin: i16, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---
	...
	copy_area_checked :: proc(c: ^Connection, srcDrawable: u32, dstDrawable: u32, gc: u32, srcX: i16, srcY: i16, dstX: i16, dstY: i16, width: u16, height: u16) -> VoidCookie ---

	@(link_name = "xcb_copy_area")
	copy_area :: proc(c: ^Connection, srcDrawable: u32, dstDrawable: u32, gc: u32, srcX: i16, srcY: i16, dstX: i16, dstY: i16, width: u16, height: u16) -> VoidCookie ---

	@(link_name = "xcb_copy_plane_checked")
	copy_plane_checked :: proc(c: ^Connection, srcDrawable: u32, dstDrawable: u32, gc: u32, srcX: i16, srcY: i16, dstX: i16, dstY: i16, width: u16, height: u16, bitPlane: u32) -> VoidCookie ---

	@(link_name = "xcb_copy_plane")
	copy_plane :: proc(c: ^Connection, srcDrawable: u32, dstDrawable: u32, gc: u32, srcX: i16, srcY: i16, dstX: i16, dstY: i16, width: u16, height: u16, bitPlane: u32) -> VoidCookie ---

	@(link_name = "xcb_poly_point_sizeof")
	poly_point_sizeof :: proc(Buffer: rawptr, pointsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_point_checked")
	poly_point_checked :: proc(c: ^Connection, coordinateMode: u8, drawable: u32, gc: u32, pointsLen: u32, points: ^Point) -> VoidCookie ---

	@(link_name = "xcb_poly_point")
	poly_point :: proc(c: ^Connection, coordinateMode: u8, drawable: u32, gc: u32, pointsLen: u32, points: ^Point) -> VoidCookie ---
	...
	poly_line_sizeof :: proc(Buffer: rawptr, pointsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_line_checked")
	poly_line_checked :: proc(c: ^Connection, coordinateMode: u8, drawable: u32, gc: u32, pointsLen: u32, points: ^Point) -> VoidCookie ---

	@(link_name = "xcb_poly_line")
	poly_line :: proc(c: ^Connection, coordinateMode: u8, drawable: u32, gc: u32, pointsLen: u32, points: ^Point) -> VoidCookie ---
	...
	poly_segment_sizeof :: proc(Buffer: rawptr, segmentsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_segment_checked")
	poly_segment_checked :: proc(c: ^Connection, drawable: u32, gc: u32, segmentsLen: u32, segments: ^Segment) -> VoidCookie ---

	@(link_name = "xcb_poly_segment")
	poly_segment :: proc(c: ^Connection, drawable: u32, gc: u32, segmentsLen: u32, segments: ^Segment) -> VoidCookie ---
	...
	poly_rectangle_sizeof :: proc(Buffer: rawptr, rectanglesLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_rectangle_checked")
	poly_rectangle_checked :: proc(c: ^Connection, drawable: u32, gc: u32, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---

	@(link_name = "xcb_poly_rectangle")
	poly_rectangle :: proc(c: ^Connection, drawable: u32, gc: u32, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---
	...
	poly_arc_sizeof :: proc(Buffer: rawptr, arcsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_arc_checked")
	poly_arc_checked :: proc(c: ^Connection, drawable: u32, gc: u32, arcsLen: u32, arcs: ^Arc) -> VoidCookie ---

	@(link_name = "xcb_poly_arc")
	poly_arc :: proc(c: ^Connection, drawable: u32, gc: u32, arcsLen: u32, arcs: ^Arc) -> VoidCookie ---
	...
	fill_poly_sizeof :: proc(Buffer: rawptr, pointsLen: u32) -> _c.int ---

	@(link_name = "xcb_fill_poly_checked")
	fill_poly_checked :: proc(c: ^Connection, drawable: u32, gc: u32, shape: u8, coordinateMode: u8, pointsLen: u32, points: ^Point) -> VoidCookie ---

	@(link_name = "xcb_fill_poly")
	fill_poly :: proc(c: ^Connection, drawable: u32, gc: u32, shape: u8, coordinateMode: u8, pointsLen: u32, points: ^Point) -> VoidCookie ---
	...
	poly_fill_rectangle_sizeof :: proc(Buffer: rawptr, rectanglesLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_fill_rectangle_checked")
	poly_fill_rectangle_checked :: proc(c: ^Connection, drawable: u32, gc: u32, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---

	@(link_name = "xcb_poly_fill_rectangle")
	poly_fill_rectangle :: proc(c: ^Connection, drawable: u32, gc: u32, rectanglesLen: u32, rectangles: ^Rectangle) -> VoidCookie ---
	...
	poly_fill_arc_sizeof :: proc(Buffer: rawptr, arcsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_fill_arc_checked")
	poly_fill_arc_checked :: proc(c: ^Connection, drawable: u32, gc: u32, arcsLen: u32, arcs: ^Arc) -> VoidCookie ---

	@(link_name = "xcb_poly_fill_arc")
	poly_fill_arc :: proc(c: ^Connection, drawable: u32, gc: u32, arcsLen: u32, arcs: ^Arc) -> VoidCookie ---
	...
	put_image_sizeof :: proc(Buffer: rawptr, dataLen: u32) -> _c.int ---

	@(link_name = "xcb_put_image_checked")
	put_image_checked :: proc(c: ^Connection, format: u8, drawable: u32, gc: u32, width: u16, height: u16, dstX: i16, dstY: i16, leftPad: u8, depth: u8, dataLen: u32, data: ^u8) -> VoidCookie ---

	@(link_name = "xcb_put_image")
	put_image :: proc(c: ^Connection, format: u8, drawable: u32, gc: u32, width: u16, height: u16, dstX: i16, dstY: i16, leftPad: u8, depth: u8, dataLen: u32, data: ^u8) -> VoidCookie ---
	...
	get_image :: proc(c: ^Connection, format: u8, drawable: u32, x: i16, y: i16, width: u16, height: u16, planeMask: u32) -> GetImageCookie ---

	@(link_name = "xcb_get_image_unchecked")
	get_image_unchecked :: proc(c: ^Connection, format: u8, drawable: u32, x: i16, y: i16, width: u16, height: u16, planeMask: u32) -> GetImageCookie ---
	...
	poly_text_8_sizeof :: proc(Buffer: rawptr, itemsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_text_8_checked")
	poly_text_8_checked :: proc(c: ^Connection, drawable: u32, gc: u32, x: i16, y: i16, itemsLen: u32, items: ^u8) -> VoidCookie ---

	@(link_name = "xcb_poly_text_8")
	poly_text_8 :: proc(c: ^Connection, drawable: u32, gc: u32, x: i16, y: i16, itemsLen: u32, items: ^u8) -> VoidCookie ---
	...
	poly_text_16_sizeof :: proc(Buffer: rawptr, itemsLen: u32) -> _c.int ---

	@(link_name = "xcb_poly_text_16_checked")
	poly_text_16_checked :: proc(c: ^Connection, drawable: u32, gc: u32, x: i16, y: i16, itemsLen: u32, items: ^u8) -> VoidCookie ---

	@(link_name = "xcb_poly_text_16")
	poly_text_16 :: proc(c: ^Connection, drawable: u32, gc: u32, x: i16, y: i16, itemsLen: u32, items: ^u8) -> VoidCookie ---
	...
	image_text_8_checked :: proc(c: ^Connection, stringLen: u8, drawable: u32, gc: u32, x: i16, y: i16, string: cstring) -> VoidCookie ---

	@(link_name = "xcb_image_text_8")
	image_text_8 :: proc(c: ^Connection, stringLen: u8, drawable: u32, gc: u32, x: i16, y: i16, string: cstring) -> VoidCookie ---
	...
	image_text_16_checked :: proc(c: ^Connection, stringLen: u8, drawable: u32, gc: u32, x: i16, y: i16, string: ^Char2B) -> VoidCookie ---

	@(link_name = "xcb_image_text_16")
	image_text_16 :: proc(c: ^Connection, stringLen: u8, drawable: u32, gc: u32, x: i16, y: i16, string: ^Char2B) -> VoidCookie ---
	...
	copy_colormap_and_free_checked :: proc(c: ^Connection, mid: u32, srcCmap: u32) -> VoidCookie ---

	@(link_name = "xcb_copy_colormap_and_free")
	copy_colormap_and_free :: proc(c: ^Connection, mid: u32, srcCmap: u32) -> VoidCookie ---
	...
	alloc_named_color :: proc(c: ^Connection, cmap: u32, nameLen: u16, name: cstring) -> AllocNamedColorCookie ---

	@(link_name = "xcb_alloc_named_color_unchecked")
	alloc_named_color_unchecked :: proc(c: ^Connection, cmap: u32, nameLen: u16, name: cstring) -> AllocNamedColorCookie ---
	...
	free_colors_sizeof :: proc(Buffer: rawptr, pixelsLen: u32) -> _c.int ---

	@(link_name = "xcb_free_colors_checked")
	free_colors_checked :: proc(c: ^Connection, cmap: u32, planeMask: u32, pixelsLen: u32, pixels: ^u32) -> VoidCookie ---

	@(link_name = "xcb_free_colors")
	free_colors :: proc(c: ^Connection, cmap: u32, planeMask: u32, pixelsLen: u32, pixels: ^u32) -> VoidCookie ---
	...
	store_colors_sizeof :: proc(Buffer: rawptr, itemsLen: u32) -> _c.int ---

	@(link_name = "xcb_store_colors_checked")
	store_colors_checked :: proc(c: ^Connection, cmap: u32, itemsLen: u32, items: ^Coloritem) -> VoidCookie ---

	@(link_name = "xcb_store_colors")
	store_colors :: proc(c: ^Connection, cmap: u32, itemsLen: u32, items: ^Coloritem) -> VoidCookie ---
	...
	store_named_color_checked :: proc(c: ^Connection, flags: u8, cmap: u32, pixel: u32, nameLen: u16, name: cstring) -> VoidCookie ---

	@(link_name = "xcb_store_named_color")
	store_named_color :: proc(c: ^Connection, flags: u8, cmap: u32, pixel: u32, nameLen: u16, name: cstring) -> VoidCookie ---
	...
	query_colors_sizeof :: proc(Buffer: rawptr, pixelsLen: u32) -> _c.int ---

	@(link_name = "xcb_query_colors")
	query_colors :: proc(c: ^Connection, cmap: u32, pixelsLen: u32, pixels: ^u32) -> QueryColorsCookie ---

	@(link_name = "xcb_query_colors_unchecked")
	query_colors_unchecked :: proc(c: ^Connection, cmap: u32, pixelsLen: u32, pixels: ^u32) -> QueryColorsCookie ---
	...
	lookup_color :: proc(c: ^Connection, cmap: u32, nameLen: u16, name: cstring) -> LookupColorCookie ---

	@(link_name = "xcb_lookup_color_unchecked")
	lookup_color_unchecked :: proc(c: ^Connection, cmap: u32, nameLen: u16, name: cstring) -> LookupColorCookie ---
	...
	create_cursor_checked :: proc(c: ^Connection, cid: u32, source: u32, mask: u32, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16, x: u16, y: u16) -> VoidCookie ---

	@(link_name = "xcb_create_cursor")
	create_cursor :: proc(c: ^Connection, cid: u32, source: u32, mask: u32, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16, x: u16, y: u16) -> VoidCookie ---

	@(link_name = "xcb_create_glyph_cursor_checked")
	create_glyph_cursor_checked :: proc(c: ^Connection, cid: u32, sourceFont: u32, maskFont: u32, sourceChar: u16, maskChar: u16, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16) -> VoidCookie ---

	@(link_name = "xcb_create_glyph_cursor")
	create_glyph_cursor :: proc(c: ^Connection, cid: u32, sourceFont: u32, maskFont: u32, sourceChar: u16, maskChar: u16, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16) -> VoidCookie ---
	...
	recolor_cursor_checked :: proc(c: ^Connection, cursor: u32, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16) -> VoidCookie ---

	@(link_name = "xcb_recolor_cursor")
	recolor_cursor :: proc(c: ^Connection, cursor: u32, foreRed: u16, foreGreen: u16, foreBlue: u16, backRed: u16, backGreen: u16, backBlue: u16) -> VoidCookie ---
	...
	query_extension :: proc(c: ^Connection, nameLen: u16, name: cstring) -> QueryExtensionCookie ---

	@(link_name = "xcb_query_extension_unchecked")
	query_extension_unchecked :: proc(c: ^Connection, nameLen: u16, name: cstring) -> QueryExtensionCookie ---
	...
	change_keyboard_mapping_checked :: proc(c: ^Connection, keycodeCount: u8, firstKeycode: u8, keysymsPerKeycode: u8, keysyms: ^u32) -> VoidCookie ---

	@(link_name = "xcb_change_keyboard_mapping")
	change_keyboard_mapping :: proc(c: ^Connection, keycodeCount: u8, firstKeycode: u8, keysymsPerKeycode: u8, keysyms: ^u32) -> VoidCookie ---
	...
	get_keyboard_mapping :: proc(c: ^Connection, firstKeycode: u8, count: u8) -> GetKeyboardMappingCookie ---

	@(link_name = "xcb_get_keyboard_mapping_unchecked")
	get_keyboard_mapping_unchecked :: proc(c: ^Connection, firstKeycode: u8, count: u8) -> GetKeyboardMappingCookie ---
	...
	change_keyboard_control_value_list_serialize :: proc(Buffer: ^rawptr, valueMask: u32, Aux: ^ChangeKeyboardControlValueList) -> _c.int ---

	@(link_name = "xcb_change_keyboard_control_value_list_unpack")
	change_keyboard_control_value_list_unpack :: proc(Buffer: rawptr, valueMask: u32, Aux: ^ChangeKeyboardControlValueList) -> _c.int ---

	@(link_name = "xcb_change_keyboard_control_value_list_sizeof")
	change_keyboard_control_value_list_sizeof :: proc(Buffer: rawptr, valueMask: u32) -> _c.int ---
	...
	change_keyboard_control_checked :: proc(c: ^Connection, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_keyboard_control")
	change_keyboard_control :: proc(c: ^Connection, valueMask: u32, valueList: rawptr) -> VoidCookie ---

	@(link_name = "xcb_change_keyboard_control_aux_checked")
	change_keyboard_control_aux_checked :: proc(c: ^Connection, valueMask: u32, valueList: ^ChangeKeyboardControlValueList) -> VoidCookie ---

	@(link_name = "xcb_change_keyboard_control_aux")
	change_keyboard_control_aux :: proc(c: ^Connection, valueMask: u32, valueList: ^ChangeKeyboardControlValueList) -> VoidCookie ---
	...
	change_pointer_control_checked :: proc(c: ^Connection, accelerationNumerator: i16, accelerationDenominator: i16, threshold: i16, doAcceleration: u8, doThreshold: u8) -> VoidCookie ---

	@(link_name = "xcb_change_pointer_control")
	change_pointer_control :: proc(c: ^Connection, accelerationNumerator: i16, accelerationDenominator: i16, threshold: i16, doAcceleration: u8, doThreshold: u8) -> VoidCookie ---
	...
	set_screen_saver_checked :: proc(c: ^Connection, timeout: i16, interval: i16, preferBlanking: u8, allowExposures: u8) -> VoidCookie ---

	@(link_name = "xcb_set_screen_saver")
	set_screen_saver :: proc(c: ^Connection, timeout: i16, interval: i16, preferBlanking: u8, allowExposures: u8) -> VoidCookie ---
	...
	change_hosts_checked :: proc(c: ^Connection, mode: u8, family: u8, addressLen: u16, address: ^u8) -> VoidCookie ---

	@(link_name = "xcb_change_hosts")
	change_hosts :: proc(c: ^Connection, mode: u8, family: u8, addressLen: u16, address: ^u8) -> VoidCookie ---
	...
	rotate_properties_checked :: proc(c: ^Connection, window: u32, atomsLen: u16, delta: i16, atoms: ^u32) -> VoidCookie ---

	@(link_name = "xcb_rotate_properties")
	rotate_properties :: proc(c: ^Connection, window: u32, atomsLen: u16, delta: i16, atoms: ^u32) -> VoidCookie ---
	...
	set_pointer_mapping :: proc(c: ^Connection, mapLen: u8, _map: ^u8) -> SetPointerMappingCookie ---

	@(link_name = "xcb_set_pointer_mapping_unchecked")
	set_pointer_mapping_unchecked :: proc(c: ^Connection, mapLen: u8, _map: ^u8) -> SetPointerMappingCookie ---
	...
	set_modifier_mapping :: proc(c: ^Connection, keycodesPerModifier: u8, keycodes: ^u8) -> SetModifierMappingCookie ---

	@(link_name = "xcb_set_modifier_mapping_unchecked")
	set_modifier_mapping_unchecked :: proc(c: ^Connection, keycodesPerModifier: u8, keycodes: ^u8) -> SetModifierMappingCookie ---
